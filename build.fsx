...
let project = "Local Console"
let summary = "Console application for local helpers."
...
Target.create "Release" (fun _ ->
    ...
    |> List.iter (fun runtimeId ->
        sprintf "publish -c Release /p:PublishSingleFile=true -o ./dist/%s --self-contained -r %s local-console.fsproj" runtimeId runtimeId
